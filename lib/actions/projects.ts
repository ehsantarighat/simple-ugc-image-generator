...
export async function createProjectAction(
  ...
  try {
    ...
    const parsed = projectCreateSchema.parse({
      ...
      creation_mode: formData.get("creation_mode") || "ugc_model_product",
      quality_priority: formData.get("quality_priority") || "auto",
    ...
    const { data, error } = await supabase
      ...
      .insert({
        ...
        creation_mode: parsed.creation_mode,
        quality_priority: parsed.quality_priority,
